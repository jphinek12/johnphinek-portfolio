    ...
    <section className="about" id="about">
      <div className="about-container">
        <div className="about-content">
          ...
          <p>
            I started my career as employee #2 at a luxury food startup, where I learned to build operational processes from nothing—handling product development, vendor relationships, and launch logistics.
          </p>
          <p>
            Outside of work, I've organized Toys for Tots SF for five years running, coordinating 300-500 attendees, volunteer teams, and venue logistics each December.
          </p>
        </div>
